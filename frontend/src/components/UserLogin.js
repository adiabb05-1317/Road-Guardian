  ...
  <div className="container py-5 h-100">
    <div className="row d-flex align-items-center justify-content-center h-100">
      ...
      <div className="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
        <h2 style={{font:'bolder',fontSize:'0.3',color:''}}>Login Here</h2>
        <form>

          <div className="form-outline mb-4">
            <input type="email"  value={username} onChange={(e)=>setUsername(e.target.value)} id="form1Example13" className="form-control form-control-lg" />
          ...
          <div className="form-outline mb-4">
            ...
            <label className="form-label" value={password} onChange={(e)=>setPassword(e.target.value)} for="form1Example23">Password</label>
          </div>
