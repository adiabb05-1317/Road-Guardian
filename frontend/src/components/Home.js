...
export default function Home() {
  const navigate=useNavigate();
    ...
    <div className="buttonContainer">
      ...
      <img src="https://em-content.zobj.net/thumbs/120/apple/354/hear-no-evil-monkey_1f649.png" srcset="https://em-content.zobj.net/thumbs/240/apple/354/hear-no-evil-monkey_1f649.png 2x" alt="Hear-No-Evil Monkey on Apple iOS 16.4" width="120" height="120"></img>
      </div>
